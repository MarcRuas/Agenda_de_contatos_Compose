package com.marco.agendadecontatoscompose.dao
...
interface ContatoDao {
    ...
    fun getContatoPeloId(id: String): Contato?

    @Query(
        "UPDATE tabela_contatos SET nome = :novoNome, sobrenome = :novoSobrenome, idade = :novoIdade, celular = :novoCelular " +
                "WHERE uid = :id"
    )
    fun atualizar(
        id: Int,
